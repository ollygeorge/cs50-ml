...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother and father:
            mother_probability = inherit_probability(mother, one_gene, two_genes)
            father_probability = inherit_probability(father, one_gene, two_genes)
...
def inherit_probability(parent, one_gene, two_genes):
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for i in range(len(probabilities[person]['gene'].items())):
            probabilities[person]['gene'][i] /= sum_gene_probabilities

        for i in range(len(probabilities[person]['trait'].items())):
            probabilities[person]['trait'][i] /= sum_trait_probabilities
